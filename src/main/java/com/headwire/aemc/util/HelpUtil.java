...
public class HelpUtil {
  ...
  public static final String AEMC_TEMPLATE_FOLDER = "template";
  public static final String AEMC_COMPONENT_FOLDER = "component";
  public static final String AEMC_OSGI_FOLDER = "osgi";
  public static final String AEMC_MODEL_FOLDER = "model";
  public static final String AEMC_SERVICE_FOLDER = "service";
  public static final String AEMC_SERVLET_FOLDER = "servlet";
  ...
  public static String getHelpText(final String[] args) throws IOException {
    ...
    if (args == null || args.length == 0 || (args.length == 1 && Constants.PARAM_HELP.equals(args[0]))) {
      ...
      if (Constants.TYPE_CONFIG_PROPS.equals(args[1])) {
        ...
        if (Constants.TYPE_APPS_UI_LIST.contains(args[1]) || Constants.TYPE_CORE_LIST.contains(args[1])) {
          ...
          helpText.append(getTextFromFile(getTypeHelpFolder(args[1]) + "/" + AEMC_HELP_FILE_NAME));
          helpText.append(getTextFromFile(AEMC_HELP_FILE_TARGET_NAME));
          helpText.append(getTextFromFile(getTypeHelpFolder(args[1]) + "/" + AEMC_HELP_FILE_TARGET_NAME));
          helpText.append(getTextFromFile(AEMC_HELP_FILE_ARGS));
          helpText.append(getTextFromFile(getTypeHelpFolder(args[1]) + "/" + AEMC_HELP_FILE_ARGS));
    ...
    if (addCompleteHelp) {
      ...
      // name option
      helpText.append(getTextFromFile(AEMC_HELP_FILE_NAME));
      helpText.append(getTextFromFile(AEMC_TEMPLATE_FOLDER + "/" + AEMC_HELP_FILE_NAME));
      helpText.append(getTextFromFile(AEMC_COMPONENT_FOLDER + "/" + AEMC_HELP_FILE_NAME));
      helpText.append(getTextFromFile(AEMC_OSGI_FOLDER + "/" + AEMC_HELP_FILE_NAME));
      helpText.append(getTextFromFile(AEMC_MODEL_FOLDER + "/" + AEMC_HELP_FILE_NAME));
      helpText.append(getTextFromFile(AEMC_SERVICE_FOLDER + "/" + AEMC_HELP_FILE_NAME));
      helpText.append(getTextFromFile(AEMC_SERVLET_FOLDER + "/" + AEMC_HELP_FILE_NAME));

      // targetname option
      helpText.append(getTextFromFile(AEMC_HELP_FILE_TARGET_NAME));
      helpText.append(getTextFromFile(AEMC_TEMPLATE_FOLDER + "/" + AEMC_HELP_FILE_TARGET_NAME));
      helpText.append(getTextFromFile(AEMC_COMPONENT_FOLDER + "/" + AEMC_HELP_FILE_TARGET_NAME));
      helpText.append(getTextFromFile(AEMC_OSGI_FOLDER + "/" + AEMC_HELP_FILE_TARGET_NAME));
      helpText.append(getTextFromFile(AEMC_MODEL_FOLDER + "/" + AEMC_HELP_FILE_TARGET_NAME));
      helpText.append(getTextFromFile(AEMC_SERVICE_FOLDER + "/" + AEMC_HELP_FILE_TARGET_NAME));
      helpText.append(getTextFromFile(AEMC_SERVLET_FOLDER + "/" + AEMC_HELP_FILE_TARGET_NAME));

      // args option
      helpText.append(getTextFromFile(AEMC_HELP_FILE_ARGS));
      helpText.append(getTextFromFile(AEMC_TEMPLATE_FOLDER + "/" + AEMC_HELP_FILE_ARGS));
      helpText.append(getTextFromFile(AEMC_COMPONENT_FOLDER + "/" + AEMC_HELP_FILE_ARGS));
      helpText.append(getTextFromFile(AEMC_OSGI_FOLDER + "/" + AEMC_HELP_FILE_ARGS));
      helpText.append(getTextFromFile(AEMC_MODEL_FOLDER + "/" + AEMC_HELP_FILE_ARGS));
      helpText.append(getTextFromFile(AEMC_SERVICE_FOLDER + "/" + AEMC_HELP_FILE_ARGS));
      helpText.append(getTextFromFile(AEMC_SERVLET_FOLDER + "/" + AEMC_HELP_FILE_ARGS));
    }
  ...
  public static String getTypeHelpFolder(final String type) {
    ...
    switch (type) {
      case Constants.TYPE_TEMPLATE:
      case Constants.TYPE_TEMPLATE_FULL:
        typeHelpFolder = AEMC_TEMPLATE_FOLDER;
        break;
      case Constants.TYPE_COMPONENT:
      case Constants.TYPE_COMPONENT_FULL:
        typeHelpFolder = AEMC_COMPONENT_FOLDER;
        break;
      case Constants.TYPE_OSGI:
        typeHelpFolder = AEMC_OSGI_FOLDER;
        break;
      case Constants.TYPE_MODEL:
        typeHelpFolder = AEMC_MODEL_FOLDER;
        break;
      case Constants.TYPE_SERVICE:
        typeHelpFolder = AEMC_SERVICE_FOLDER;
        break;
      case Constants.TYPE_SERVLET:
        typeHelpFolder = AEMC_SERVLET_FOLDER;
        break;
      default:
        throw new IllegalStateException("Unknown <type> argument: " + type);
    }
